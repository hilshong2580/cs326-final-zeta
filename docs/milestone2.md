...
Shing Hong Lau:
1. Fix bug from login.html and regis.html
2. Create login.js file and write a function for button to fetch to do the login check
3. Create regis.js file to write a function for button to fetch to do the account create
4. Create main.js file to do the following methods:
...
5. create server.js to set up server, default the starting page, import the login and main router.

6. create loginRouter.js to do the following work:
...
7. create mainRouter.js to do the following work :
