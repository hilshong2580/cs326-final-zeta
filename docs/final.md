...
- Create Post Page: This page will jump out after clicking the Create Post button on the main page. User needs to insert title, Destination, Outset, Time: Start, Time: End, Num of people, Description in this page. And clicking on the Save bottom at the end of the page will create a post that saves all the information that the user inserted into the database. Meanwhile, a new post will be created and shown on the main page. Clicking on the Close bottom will jump out of the Create Post Page and be back to the main page.
